  ...
  return (
    <form onSubmit={guardar} className="max-w-3xl">
      ...
      <fieldset className="grid gap-4 sm:grid-cols-2">
        ...
        <Campo label="Centro de formación" name="centro_formacion" className="sm:col-span-2" {...p} />
        <Campo label="Parroquia a la que pertenece" name="parroquia" {...p} />
        <div>
          <label className="etiqueta" htmlFor="cohorte">Cohorte</label>
          <select id="cohorte" className="campo" value={datos.cohorte_id ?? ''} onChange={(e) => setDatos({ ...datos, cohorte_id: e.target.value })}>
